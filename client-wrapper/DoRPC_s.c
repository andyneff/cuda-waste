...
extern const MIDL_SERVER_INFO DoRPC_ServerInfo;

extern const RPC_DISPATCH_TABLE DoRPC_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE DoRPC___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xF0C37BD0,0x0D1B,0x4513,{0x8C,0x51,0xEC,0x0D,0x69,0x97,0x40,0xC0}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&DoRPC_v1_0_DispatchTable,
    0,
    0,
    0,
    &DoRPC_ServerInfo,
...
RPC_IF_HANDLE DoRPC_v1_0_s_ifspec = (RPC_IF_HANDLE)& DoRPC___RpcServerInterface;
...
static const MIDL_STUB_DESC DoRPC_StubDesc = 
    {
    (void *)& DoRPC___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION DoRPC_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE DoRPC_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)DoRPC_table
    };

static const SERVER_ROUTINE DoRPC_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Here
    };

static const MIDL_SERVER_INFO DoRPC_ServerInfo = 
    {
    &DoRPC_StubDesc,
    DoRPC_ServerRoutineTable,
    DoRPC__MIDL_ProcFormatString.Format,
    DoRPC_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
