...
public:
	...
	cudaError_t _cudaBindTextureToMipmappedArray();
	...
	cudaError_t _cudaCreateSurfaceObject();
	cudaError_t _cudaCreateTextureObject();
	cudaError_t _cudaD3D10GetDevice();
	cudaError_t _cudaD3D10GetDevices();
	cudaError_t _cudaD3D10GetDirect3DDevice();
	cudaError_t _cudaD3D10MapResources();
	cudaError_t _cudaD3D10RegisterResource();
	cudaError_t _cudaD3D10ResourceGetMappedArray();
	cudaError_t _cudaD3D10ResourceGetMappedPitch();
	cudaError_t _cudaD3D10ResourceGetMappedPointer();
	cudaError_t _cudaD3D10ResourceGetMappedSize();
	cudaError_t _cudaD3D10ResourceGetSurfaceDimensions();
	cudaError_t _cudaD3D10ResourceSetMapFlags();
	cudaError_t _cudaD3D10SetDirect3DDevice();
	cudaError_t _cudaD3D10UnmapResources();
	cudaError_t _cudaD3D10UnregisterResource();
	cudaError_t _cudaD3D11GetDevice();
	cudaError_t _cudaD3D11GetDevices();
	cudaError_t _cudaD3D11GetDirect3DDevice();
	cudaError_t _cudaD3D11SetDirect3DDevice();
	cudaError_t _cudaD3D9Begin();
	cudaError_t _cudaD3D9End();
	cudaError_t _cudaD3D9GetDevice();
	cudaError_t _cudaD3D9GetDevices();
	cudaError_t _cudaD3D9GetDirect3DDevice();
	cudaError_t _cudaD3D9MapResources();
	cudaError_t _cudaD3D9MapVertexBuffer();
	cudaError_t _cudaD3D9RegisterResource();
	cudaError_t _cudaD3D9RegisterVertexBuffer();
	cudaError_t _cudaD3D9ResourceGetMappedArray();
	cudaError_t _cudaD3D9ResourceGetMappedPitch();
	cudaError_t _cudaD3D9ResourceGetMappedPointer();
	cudaError_t _cudaD3D9ResourceGetMappedSize();
	cudaError_t _cudaD3D9ResourceGetSurfaceDimensions();
	cudaError_t _cudaD3D9ResourceSetMapFlags();
	cudaError_t _cudaD3D9SetDirect3DDevice();
	cudaError_t _cudaD3D9UnmapResources();
	cudaError_t _cudaD3D9UnmapVertexBuffer();
	cudaError_t _cudaD3D9UnregisterResource();
	cudaError_t _cudaD3D9UnregisterVertexBuffer();
	cudaError_t _cudaDestroySurfaceObject();
	cudaError_t _cudaDestroyTextureObject();
	cudaError_t _cudaDeviceCanAccessPeer();
	cudaError_t _cudaDeviceDisablePeerAccess();
	cudaError_t _cudaDeviceEnablePeerAccess();
	cudaError_t _cudaDeviceGetAttribute();
	cudaError_t _cudaDeviceGetByPCIBusId();
	cudaError_t _cudaDeviceGetCacheConfig();
	cudaError_t _cudaDeviceGetLimit();
	cudaError_t _cudaDeviceGetPCIBusId();
	cudaError_t _cudaDeviceGetSharedMemConfig();
	cudaError_t _cudaDeviceGetStreamPriorityRange();
	cudaError_t _cudaDeviceReset();
	cudaError_t _cudaDeviceSetCacheConfig();
	cudaError_t _cudaDeviceSetLimit();
	cudaError_t _cudaDeviceSetSharedMemConfig();
	cudaError_t _cudaDeviceSynchronize();
	...
	cudaError_t _cudaFreeMipmappedArray();
	...
	cudaError_t _cudaGetTextureObjectTextureDesc();
    cudaError_t _cudaGetTextureReference(const struct textureReference **texref, const char *symbol);
	cudaError_t _cudaGLGetDevices();
	cudaError_t _cudaGLMapBufferObject();
	cudaError_t _cudaGLMapBufferObjectAsync();
	cudaError_t _cudaGLRegisterBufferObject();
	cudaError_t _cudaGLSetBufferObjectMapFlags();
	cudaError_t _cudaGLSetGLDevice();
	cudaError_t _cudaGLUnmapBufferObject();
	cudaError_t _cudaGLUnmapBufferObjectAsync();
	cudaError_t _cudaGLUnregisterBufferObject();
	cudaError_t _cudaGraphicsD3D10RegisterResource();
	cudaError_t _cudaGraphicsD3D11RegisterResource();
	cudaError_t _cudaGraphicsD3D9RegisterResource();
	cudaError_t _cudaGraphicsGLRegisterBuffer();
	cudaError_t _cudaGraphicsGLRegisterImage();
	...
	cudaError_t _cudaHostRegister();
	cudaError_t _cudaHostUnregister();
	cudaError_t _cudaIpcCloseMemHandle();
	cudaError_t _cudaIpcGetEventHandle();
	cudaError_t _cudaIpcGetMemHandle();
	cudaError_t _cudaIpcOpenEventHandle();
	...
	cudaError_t _cudaMemcpy3DPeer();
	cudaError_t _cudaMemcpy3DPeerAsync();
	...
	cudaError_t _cudaMemcpyPeer();
	cudaError_t _cudaMemcpyPeerAsync();
	...
	cudaError_t _cudaPointerGetAttributes();
	cudaError_t _cudaProfilerStart();
	cudaError_t _cudaProfilerStop();
	cudaError_t _cudaRegisterDeviceFunction();
	...
	cudaError_t _cudaRegisterPrelinkedFatBinary();
	cudaError_t _cudaRegisterShared();
	cudaError_t _cudaRegisterSharedVar();
	...
	cudaError_t _cudaWGLGetDevice();
	cudaError_t _NvOptimusEnablementCuda();
