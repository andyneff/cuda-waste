...
cudaError_t NVIDIA_GPU::_cudaGetLastError()
{
...
cudaError_t NVIDIA_GPU::_cudaMalloc(void ** ptr, size_t size)
{
    void * local = 0;
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
    char * context = cu->Context();
...
void** NVIDIA_GPU::_cudaRegisterFatBinary(void *fatCubin)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
void NVIDIA_GPU::ExitHandler()
{
}

CUresult NVIDIA_GPU::_cuDeviceComputeCapability(int *major, int *minor, CUdevice dev)
{
	CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxAttach(CUcontext *pctx, unsigned int flags)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxCreate(CUcontext *pctx, unsigned int flags, CUdevice dev )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxCreate_v2(CUcontext *pctx, unsigned int flags, CUdevice dev )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxDestroy( CUcontext ctx )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxDetach(CUcontext ctx)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxGetDevice(CUdevice *device)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxGetLimit(size_t *pvalue, CUlimit limit)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxPopCurrent( CUcontext *pctx )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxPushCurrent( CUcontext ctx )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxSetLimit(CUlimit limit, size_t value)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuCtxSynchronize(void)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceGet(CUdevice *device, int ordinal)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceGetAttribute(int *pi, CUdevice_attribute attrib, CUdevice dev)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceGetCount(int *count)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceGetName(char *name, int len, CUdevice dev)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceGetProperties(CUdevprop *prop, CUdevice dev)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceTotalMem(unsigned int *bytes, CUdevice dev)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDeviceTotalMem_v2(unsigned int *bytes, CUdevice dev)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuDriverGetVersion(int *driverVersion)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuEventCreate( CUevent *phEvent, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuEventDestroy( CUevent hEvent )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuEventElapsedTime( float *pMilliseconds, CUevent hStart, CUevent hEnd )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuEventQuery( CUevent hEvent )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuEventRecord( CUevent hEvent, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuEventSynchronize( CUevent hEvent )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuFuncGetAttribute (int *pi, CUfunction_attribute attrib, CUfunction hfunc)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuFuncSetBlockShape (CUfunction hfunc, int x, int y, int z)
{
...
CUresult NVIDIA_GPU::_cuFuncSetCacheConfig(CUfunction hfunc, CUfunc_cache config)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuFuncSetSharedSize (CUfunction hfunc, unsigned int bytes)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGetExportTable( const void **ppExportTable, const CUuuid *pExportTableId )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsMapResources( unsigned int count, CUgraphicsResource *resources, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsResourceGetMappedPointer( CUdeviceptr *pDevPtr, unsigned int *pSize, CUgraphicsResource resource )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsResourceGetMappedPointer_v2( CUdeviceptr *pDevPtr, unsigned int *pSize, CUgraphicsResource resource )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsResourceSetMapFlags( CUgraphicsResource resource, unsigned int flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsSubResourceGetMappedArray( CUarray *pArray, CUgraphicsResource resource, unsigned int arrayIndex, unsigned int mipLevel )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsUnmapResources( unsigned int count, CUgraphicsResource *resources, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuGraphicsUnregisterResource(CUgraphicsResource resource)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuInit(unsigned int Flags)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuLaunch ( CUfunction f )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuLaunchGrid (CUfunction f, int grid_width, int grid_height)
{
    // set up dimensions, shared memory, and stream for the kernel launch.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuLaunchGridAsync( CUfunction f, int grid_width, int grid_height, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemAlloc( CUdeviceptr *dptr, unsigned int bytesize)
{
...
CUresult NVIDIA_GPU::_cuMemAlloc_v2( CUdeviceptr *dptr, unsigned int bytesize)
{
    // Basic, no frills, allocation.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemAllocHost(void **pp, unsigned int bytesize)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemAllocHost_v2(void **pp, unsigned int bytesize)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemAllocPitch( CUdeviceptr *dptr, unsigned int *pPitch, unsigned int WidthInBytes, unsigned int Height, unsigned int ElementSizeBytes)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemAllocPitch_v2( CUdeviceptr *dptr, unsigned int *pPitch, unsigned int WidthInBytes, unsigned int Height, unsigned int ElementSizeBytes)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy2D( const CUDA_MEMCPY2D *pCopy )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy2D_v2( const CUDA_MEMCPY2D *pCopy )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy2DAsync( const CUDA_MEMCPY2D *pCopy, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy2DAsync_v2( const CUDA_MEMCPY2D *pCopy, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy2DUnaligned( const CUDA_MEMCPY2D *pCopy )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy2DUnaligned_v2( const CUDA_MEMCPY2D *pCopy )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy3D( const CUDA_MEMCPY3D *pCopy )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy3D_v2( const CUDA_MEMCPY3D *pCopy )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy3DAsync( const CUDA_MEMCPY3D *pCopy, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpy3DAsync_v2( const CUDA_MEMCPY3D *pCopy, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoA( CUarray dstArray, unsigned int dstOffset, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoA_v2( CUarray dstArray, unsigned int dstOffset, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoD ( CUdeviceptr dstDevice, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoD_v2 ( CUdeviceptr dstDevice, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoH( void *dstHost, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoH_v2( void *dstHost, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoHAsync( void *dstHost, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyAtoHAsync_v2( void *dstHost, CUarray srcArray, unsigned int srcOffset, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoA ( CUarray dstArray, unsigned int dstOffset, CUdeviceptr srcDevice, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoA_v2 ( CUarray dstArray, unsigned int dstOffset, CUdeviceptr srcDevice, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoD (CUdeviceptr dstDevice, CUdeviceptr srcDevice, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoD_v2 (CUdeviceptr dstDevice, CUdeviceptr srcDevice, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoDAsync (CUdeviceptr dstDevice, CUdeviceptr srcDevice, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoDAsync_v2 (CUdeviceptr dstDevice, CUdeviceptr srcDevice, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoH (void *dstHost, CUdeviceptr srcDevice, unsigned int ByteCount )
{
    // Basic, no frills.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoH_v2 (void *dstHost, CUdeviceptr srcDevice, unsigned int ByteCount )
{
    // Basic, no frills.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoHAsync (void *dstHost, CUdeviceptr srcDevice, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyDtoHAsync_v2 (void *dstHost, CUdeviceptr srcDevice, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoA( CUarray dstArray, unsigned int dstOffset, const void *srcHost, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoA_v2( CUarray dstArray, unsigned int dstOffset, const void *srcHost, unsigned int ByteCount )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoAAsync( CUarray dstArray, unsigned int dstOffset, const void *srcHost, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoAAsync_v2( CUarray dstArray, unsigned int dstOffset, const void *srcHost, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoD (CUdeviceptr dstDevice, const void *srcHost, unsigned int ByteCount )
{
    // Basic, no frills.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoD_v2 (CUdeviceptr dstDevice, const void *srcHost, unsigned int ByteCount )
{
    // Basic, no frills.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoDAsync (CUdeviceptr dstDevice, const void *srcHost, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemcpyHtoDAsync_v2 (CUdeviceptr dstDevice, const void *srcHost, unsigned int ByteCount, CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemFree(CUdeviceptr dptr)
{
    // Basic, no frills.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemFree_v2(CUdeviceptr dptr)
{
    // Basic, no frills.
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemFreeHost(void *p)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemGetAddressRange( CUdeviceptr *pbase, unsigned int *psize, CUdeviceptr dptr )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemGetAddressRange_v2( CUdeviceptr *pbase, unsigned int *psize, CUdeviceptr dptr )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemGetInfo(unsigned int *free, unsigned int *total)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemGetInfo_v2(unsigned int *free, unsigned int *total)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemHostAlloc(void **pp, size_t bytesize, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemHostGetDevicePointer( CUdeviceptr *pdptr, void *p, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemHostGetDevicePointer_v2( CUdeviceptr *pdptr, void *p, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemHostGetFlags( unsigned int *pFlags, void *p )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD16( CUdeviceptr dstDevice, unsigned short us, unsigned int N )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD16_v2( CUdeviceptr dstDevice, unsigned short us, unsigned int N )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD2D16( CUdeviceptr dstDevice, unsigned int dstPitch, unsigned short us, unsigned int Width, unsigned int Height )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD2D16_v2( CUdeviceptr dstDevice, unsigned int dstPitch, unsigned short us, unsigned int Width, unsigned int Height )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD2D32( CUdeviceptr dstDevice, unsigned int dstPitch, unsigned int ui, unsigned int Width, unsigned int Height )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD2D32_v2( CUdeviceptr dstDevice, unsigned int dstPitch, unsigned int ui, unsigned int Width, unsigned int Height )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD2D8( CUdeviceptr dstDevice, unsigned int dstPitch, unsigned char uc, unsigned int Width, unsigned int Height )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD2D8_v2( CUdeviceptr dstDevice, unsigned int dstPitch, unsigned char uc, unsigned int Width, unsigned int Height )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD32( CUdeviceptr dstDevice, unsigned int ui, unsigned int N )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD32_v2( CUdeviceptr dstDevice, unsigned int ui, unsigned int N )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
        _CUDA::ptr_cuMemsetD32 proc = (_CUDA::ptr_cuMemsetD32)cu->hook_manager->FindOriginal((PROC)_CUDA::_cuMemsetD32);
        return (*proc)( dstDevice, ui, N );
...
CUresult NVIDIA_GPU::_cuMemsetD8( CUdeviceptr dstDevice, unsigned char uc, unsigned int N )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuMemsetD8_v2( CUdeviceptr dstDevice, unsigned char uc, unsigned int N )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleGetFunction(CUfunction *hfunc, CUmodule hmod, const char *name)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleGetGlobal(CUdeviceptr *dptr, unsigned int *bytes, CUmodule hmod, const char *name)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleGetGlobal_v2(CUdeviceptr *dptr, unsigned int *bytes, CUmodule hmod, const char *name)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleGetSurfRef(CUsurfref *pSurfRef, CUmodule hmod, const char *name)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleGetTexRef(CUtexref *pTexRef, CUmodule hmod, const char *name)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleLoad(CUmodule *module, const char *fname)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleLoadData(CUmodule *module, const void *image)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleLoadDataEx(CUmodule *module, const void *image, unsigned int numOptions, CUjit_option *options, void **optionValues)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleLoadFatBinary(CUmodule *module, const void *fatCubin)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuModuleUnload(CUmodule hmod)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuParamSetf    (CUfunction hfunc, int offset, float value)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuParamSeti    (CUfunction hfunc, int offset, unsigned int value)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuParamSetSize (CUfunction hfunc, unsigned int numbytes)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuParamSetTexRef(CUfunction hfunc, int texunit, CUtexref hTexRef)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuParamSetv(CUfunction hfunc, int offset, void *ptr, unsigned int numbytes)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuStreamCreate( CUstream *phStream, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuStreamDestroy( CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuStreamQuery( CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuStreamSynchronize( CUstream hStream )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuSurfRefGetArray( CUarray *phArray, CUsurfref hSurfRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuSurfRefSetArray( CUsurfref hSurfRef, CUarray hArray, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefCreate( CUtexref *pTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefDestroy( CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetAddress( CUdeviceptr *pdptr, CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetAddress_v2( CUdeviceptr *pdptr, CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetAddressMode( CUaddress_mode *pam, CUtexref hTexRef, int dim )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetArray( CUarray *phArray, CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetFilterMode( CUfilter_mode *pfm, CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetFlags( unsigned int *pFlags, CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefGetFormat( CUarray_format *pFormat, int *pNumChannels, CUtexref hTexRef )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetAddress( unsigned int *ByteOffset, CUtexref hTexRef, CUdeviceptr dptr, unsigned int bytes )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetAddress_v2( unsigned int *ByteOffset, CUtexref hTexRef, CUdeviceptr dptr, unsigned int bytes )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetAddress2D( CUtexref hTexRef, const CUDA_ARRAY_DESCRIPTOR *desc, CUdeviceptr dptr, unsigned int Pitch)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetAddress2D_v2( CUtexref hTexRef, const CUDA_ARRAY_DESCRIPTOR *desc, CUdeviceptr dptr, unsigned int Pitch)
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetAddressMode( CUtexref hTexRef, int dim, CUaddress_mode am )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetArray( CUtexref hTexRef, CUarray hArray, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetFilterMode( CUtexref hTexRef, CUfilter_mode fm )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetFlags( CUtexref hTexRef, unsigned int Flags )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
...
CUresult NVIDIA_GPU::_cuTexRefSetFormat( CUtexref hTexRef, CUarray_format fmt, int NumPackedComponents )
{
    CUDA_WRAPPER * cu = CUDA_WRAPPER::Singleton();
