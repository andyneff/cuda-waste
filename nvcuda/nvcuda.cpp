...
DllExport CUresult CUDAAPI cuDeviceGetCount(int *count)
{
    return CUDA_SUCCESS;
}

DllExport CUresult CUDAAPI cuDeviceGetName(char *name, int len, CUdevice dev)
{
    return CUDA_SUCCESS;
}
...
DllExport CUresult CUDAAPI cuDeviceTotalMem(unsigned int *bytes, CUdevice dev)
{
    return CUDA_SUCCESS;
}
...
DllExport CUresult CUDAAPI cuFuncGetAttribute (int *pi, CUfunction_attribute attrib, CUfunction hfunc)
{
    return CUDA_SUCCESS;
}
...
DllExport CUresult CUDAAPI cuLaunch ( CUfunction f )
{
    return CUDA_SUCCESS;
}

DllExport CUresult CUDAAPI cuLaunchGrid (CUfunction f, int grid_width, int grid_height)
{
    return CUDA_SUCCESS;
}

DllExport CUresult CUDAAPI cuLaunchGridAsync( CUfunction f, int grid_width, int grid_height, CUstream hStream )
{
    return CUDA_SUCCESS;
}
